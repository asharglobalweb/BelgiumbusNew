          ...
          <div className="space-y-8 animate-slide-up">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Plan Your <span className="text-blue-600">Group Trip</span> in
                Belgium
              </h2>
              <p className="text-gray-700 text-xl leading-relaxed">
                Get a personalized quote from{" "}
                <strong className="text-blue-600">Belgium Buses</strong> for
                comfortable, safe group transport to Brussels, Antwerp, Ghent,
                and beyond.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    From Brussels to every corner of Belgium
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Trusted by thousands of passengers across Belgium
                  </p>
                </div>
              </div>
            </div>
